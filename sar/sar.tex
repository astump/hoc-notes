...
\begin{figure}
  ...
  \begin{array}{llll}
    ...
    x\ |\ u\ |\ \mathbf{f}[\bar{M}]\ |\ \tlam{x}{M}{N}\ |\ M\ N\ |\\
...
\[
\tlam{A}{\star}{\tlam{x}{\mathsf{List}\ A}{\texttt{Nat}}}
\]
\noindent This function takes in a type $A$, and then returns a
function taking in an $x$ of type $\mathsf{List}\ A$ and returning
\texttt{Nat}.  Such a function is abstract, as the
...
is:
\[
\tlam{A}{\star}{\mathsf{List}\ A \to \texttt{Nat}}
\]
