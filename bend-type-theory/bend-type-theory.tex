...
\begin{figure}
  ...
  \begin{subfigure}[c]{1.0\textwidth}
    \begin{mathpar}
      \inferrule[a-var]{x : T \in \Gamma}
                     {\Gamma \vdash x : T}

      \inferrule[a-conv]{\Gamma \vdash t : T \\ \betaeq{|T|}{|T'|}}
                      {\Gamma \vdash t : T'}
      \\
      \inferrule[a-tt-abs]{\Gamma \vdash \Pia{x}{T}{T'} : \star \\ \Gamma, x : T \vdash t : T'}
                        {\Gamma \vdash \tlam{x}{T}{t} : \Pia{x}{T}{T'}}

      \inferrule[a-kt-abs]{\Gamma \vdash \Pia{X}{\kappa}{T} : \star \\ \Gamma, X : \kappa \vdash t : T}
                       {\Gamma \vdash \tlam{X}{\kappa}{t} : \Pia{X}{\kappa}{T}}
      \\
      \inferrule[a-tt-app]{\Gamma \vdash t : \Pia{x}{T}{T'} \\ \Gamma \vdash t' : T}
                        {\Gamma \vdash t\ t' : \subst{t'}{x}{T'}}

      \inferrule[a-tt-app]{\Gamma \vdash t : \Pia{x}{\kappa}{T'} \\ \Gamma \vdash T : \kappa}
                        {\Gamma \vdash t\ T : \subst{T}{x}{T'}}
    \end{mathpar}
    \caption{Typing}
    \label{fig:tc-atm}
