...
%% The representation of lists with W-types is slightly annoying, because
...
%% \]
%% \noindent For uniformity (so that given a list of unknown form, we can find the label telling
%% whether it is a \textsf{@cons} or a \textsf{@nil}), one then needs
%% \[
%% \textit{Nil}\ :=\ \ctor{(\mathsf{@nil},\wunit)}{\lam{x}{\wunit}}
%% \]
%% \noindent This is a little clunky, because then a function like append needs to dig in a level to the label part of the construction,
%% to find out which case should be applied:
%\[
%\textit{append}\ :=\ \lam{x}{\lam{y}{\wrec{\lam{l}{\lam{p}{\lam{r}{\{ \mathsf{@cons} \mapsto 
